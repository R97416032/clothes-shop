		...
		<view class="login-form">
			<form @submit="formSubmit">
				<view class="form-input">
					<input type="text" v-model="uname" placeholder="手机号" />
				</view>
				<view class="form-input">
					<input type="password" v-model="passw" placeholder="密码" @focus="passwordF_B" @blur="passwordF_B" />
				</view>
				<button v-on:click="goto()" type="primary" form-type="submit">登录</button>
			</form>
			<text style="width: 60px; height: 60px; margin-left: 200px; margin-top: 50px;" @click="register()">新用户注册</text>
		</view>
	</view>
</template>
